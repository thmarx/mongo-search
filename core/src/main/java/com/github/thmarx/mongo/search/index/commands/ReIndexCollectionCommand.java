...
public class ReIndexCollectionCommand implements Command {

    private final String collection;

    @Override
    public void execute(final IndexAdapter indexAdapter, MongoDatabase database) {
        try {
            indexAdapter.pauseQueueWorker();

            log.debug("reindex collection " + collection);
